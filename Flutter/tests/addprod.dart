        ...
        body: Padding(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: rateValue,
                  name: "Rate Value",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: grossWValue,
                  name: "Gross W",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: stoneWValue,
                  name: "Stone W",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: makingCValue,
                  name: "Making C",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: wastageCValue,
                  name: "Wastage C",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: stoneCValue,
                  name: "Stone C",
                  myContext: context),
              SizedBox(height: paddingHeight),
              ...
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: netAValue, name: "Net A", myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: totalAValue,
                  name: "Total A",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: validDValue,
                  name: "Valid D",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: qtyValue, name: "Qty", myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: vendorValue,
                  name: "Vendor",
                  myContext: context),
              SizedBox(height: paddingHeight),
              TextFormWidget(
                  myController: submitDateValue,
                  name: "Submit Date",
                  myContext: context),
              SizedBox(height: paddingHeight),
              Row(
